import{_ as s,c as i,a,U as n,k as t,o as l}from"./chunks/framework.iPPbIJ9E.js";const p="/front-end-notes/assets/virtual-scroll-01.SLblFOHB.webp",h="/front-end-notes/assets/virtual-scroll-02.bTnk4zxv.png",m=JSON.parse('{"title":"写写虚拟滚动的示例","description":"","frontmatter":{},"headers":[],"relativePath":"column/front-end/study/others/virtual-scroll.md","filePath":"column/front-end/study/others/virtual-scroll.md","lastUpdated":1709178956000}'),e={name:"column/front-end/study/others/virtual-scroll.md"},k=n('<h1 id="写写虚拟滚动的示例" tabindex="-1">写写虚拟滚动的示例 <a class="header-anchor" href="#写写虚拟滚动的示例" aria-label="Permalink to &quot;写写虚拟滚动的示例&quot;">​</a></h1><h2 id="一、虚拟滚动" tabindex="-1">一、虚拟滚动 <a class="header-anchor" href="#一、虚拟滚动" aria-label="Permalink to &quot;一、虚拟滚动&quot;">​</a></h2><p>虚拟滚动(虚拟列表)，是一种技术实现方案。针对需要展示大数据量的表格进行渲染优化。假设有10w数据需要展示在页面上，一次性全部进行展示显然会让页面直接卡爆。</p><p>可能会有很多种方式解决：<code>分页，懒加载，时间分片</code>都可来进行优化渲染，但是他们各有各的不足之处</p><p><strong>分页</strong>：简单粗暴，每次只展示固定数量，想要浏览更多，只能切换到下一页</p><p><strong>懒加载</strong>：此场景下可以假设是触底加载更多。页面初次仅展示20条，触底时再新增一些数据进行渲染。(随着触发次数的增加，列表元素的DOM也在增加，最终也会造成页面卡顿)</p><p><strong>时间分片</strong>：与懒加载略有不同，规定每次页面每次渲染一定个数，渲染完毕之后再渲染下一批，直到全部完成渲染。(弊端与懒加载类似，并且每次页面渲染都可能会造成闪动)</p><blockquote><p><strong>以上方案共有的问题</strong></p><p><code>懒加载、时间分片</code>都不可避免地可能在列表中渲染了大量的DOM，如果每一列表项都是简单的渲染还好，但凡每一项内容量复杂，都会造成性能问题。</p></blockquote><p>虚拟列表就很好地回避了这个问题，通过计算每次仅仅渲染可视区域的内容。</p><p><img src="'+p+`" alt="虚拟滚动.jpg"></p><h2 id="二、简单示例" tabindex="-1">二、简单示例 <a class="header-anchor" href="#二、简单示例" aria-label="Permalink to &quot;二、简单示例&quot;">​</a></h2><div class="language-xml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">xml</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">template</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
